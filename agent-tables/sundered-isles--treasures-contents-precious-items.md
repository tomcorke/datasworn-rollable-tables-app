...
- **Table ID:** `sundered_isles/treasures/contents/precious_items`
- **Source data:** `src/data/sundered_isles-treasures.yaml`
## Description
...
Cache of coins, gems, and jewels
...
Rare medicinal herbs or compounds
