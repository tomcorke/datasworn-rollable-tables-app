...
- **Table ID:** `sundered_isles/seafaring/collections/waypoints/collections/unknown_waters/contents/myriads`
...
**References**
- **Islands** - [sundered_isles/collections/oracles/islands](#unresolved-reference) *(unresolved in bundled data)*
