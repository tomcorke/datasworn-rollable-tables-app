...
- **Table ID:** `starforged/settlements/contents/first_look`
- **Source data:** `src/data/starforged-settlements.yaml`
## Description
...
Within or near [Precursor Vault](#unresolved-reference) *(unresolved in bundled data)*
