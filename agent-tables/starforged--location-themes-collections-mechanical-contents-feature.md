# feature
- **Ruleset:** starforged
- **Collection:** Location Theme Oracles
- **Table ID:** `starforged/location_themes/collections/mechanical/contents/feature`
- **Source data:** `src/data/starforged-location_themes.yaml`
## Description
