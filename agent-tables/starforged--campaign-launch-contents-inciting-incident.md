# Inciting Incident
- **Ruleset:** starforged
- **Collection:** Campaign Launch Oracles
- **Table ID:** `starforged/campaign_launch/contents/inciting_incident`
- **Source data:** `src/data/starforged-campaign_launch.yaml`
## Description
...
Escort a tradeship carrying a prized cargo
