...
- **Table ID:** `sundered_isles/misc/contents/prompts`
- **Source data:** `src/data/sundered_isles-misc.yaml`
## Description

Use this table to choose a structured prompt from among the Core oracles (pages 112–115). Roll on each table and interpret the response as appropriate to the question and situation.
## Results
### 1-20
